        ...
        <div class="report-container">
            ...
            <div class="table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        <?php foreach ($data as $product): ?>
                            <tr class="<?php echo $product['days_until_expiration'] <= 3 ? 'bg-red-50' : ($product['days_until_expiration'] <= 7 ? 'bg-yellow-50' : 'bg-orange-50'); ?>">
                                <td><?php echo htmlspecialchars($product['name']); ?></td>
                                <td><?php echo date('M d, Y', strtotime($product['expiration_date'])); ?></td>
                                <td class="font-bold text-<?php echo $product['days_until_expiration'] <= 3 ? 'red' : ($product['days_until_expiration'] <= 7 ? 'yellow' : 'orange'); ?>">
                                    <?php echo $product['days_until_expiration']; ?> days
                                </td>
                                <td><?php echo $product['stock']; ?></td>
                                <td>₱<?php echo number_format($product['stock'] * $product['price'], 2); ?></td>
                                <td>
                                    ...
                                    ?>
                                    <a href="/bakery-website/admin/inventory.php?action=update_stock&id=<?php echo $product['id']; ?>" 
                                       class="bg-<?php echo $bgColor; ?>-600 text-white px-3 py-1 rounded hover:bg-<?php echo $bgColor; ?>-700 text-sm">
                                        Use Now
                                    </a>
                                </td>
                            </tr>
                        ...
                        <?php foreach ($data as $category): ?>
                            <div class="flex justify-between items-center">
                                <div class="flex items-center">
                                    <div class="w-4 h-4 rounded" style="background-color: <?php 
                                        echo '#' . substr(md5($category['category']), 0, 6); ?>"></div>
                                    <span class="ml-2 font-medium"><?php echo ucfirst(htmlspecialchars($category['category'])); ?></span>
                                </div>
                                <span class="text-sm text-gray-600">
                                    <?php echo $category['count']; ?> products • ₱<?php echo number_format($category['total_value'], 2); ?>
                                </span>
                            </div>
                        <?php endforeach; ?>
                    </div>
